...
class SimpleNN(nn.Module):
    ...
    def __init__(self):
        ...
        # Define the layers
        self.fc1 = nn.Linear(10, 5)  # First fully connected layer (input: 10, output: 5)
        self.fc2 = nn.Linear(5, 3)  # Second fully connected layer (input: 5, output: 3)
        self.fc3 = nn.Linear(3, 1)   # Third fully connected layer (input: 3, output: 1)
